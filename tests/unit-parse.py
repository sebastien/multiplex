...
def test_delay_seconds():
    ...
    expected = ParsedCommand(None, None, 5.0, [], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_delay_float():
    ...
    expected = ParsedCommand(None, None, 1.5, [], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_named_with_delay():
    ...
    expected = ParsedCommand("A", None, 5.0, [], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_single_action():
    ...
    expected = ParsedCommand(None, None, None, ["silent"], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_multiple_actions():
    ...
    expected = ParsedCommand(None, None, None, ["silent", "end"], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_complex_command():
    ...
    expected = ParsedCommand("A", None, 1.5, ["silent", "end"], ["python", "-m", "http.server"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_benchmark_example():
    ...
    expected = ParsedCommand(None, None, 1.0, ["end"], ["ab", "-n1000", "http://localhost:8000/"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_command_with_paths():
    ...
    expected = ParsedCommand(None, None, None, [], ["/usr/bin/python3", "/path/to/script.py"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_command_with_flags():
    ...
    expected = ParsedCommand(None, None, None, [], ["curl", "-X", "POST", "-H", "Content-Type: application/json", "https://api.example.com"])
    assert result == expected, f"Expected {expected}, got {result}"
