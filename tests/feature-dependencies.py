...
def test_basic_command_no_dependencies():
    ...
    expected = ParsedCommand(None, None, [], [], ["echo", "hello"])
...
def test_named_command_no_dependencies():
    ...
    expected = ParsedCommand("A", None, [], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_simple_dependency():
    ...
    result = parse(":A=echo hello")
    expected = ParsedCommand(None, None, [Dependency("A", False, [])], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_dependency_with_start_indicator():
    ...
    result = parse(":A&=echo hello")
    expected = ParsedCommand(None, None, [Dependency("A", True, [])], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_dependency_with_delay():
    ...
    expected = ParsedCommand(None, None, [Dependency("A", False, [1.0])], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_dependency_with_start_and_delay():
    ...
    expected = ParsedCommand(None, None, [Dependency("A", True, [0.5])], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_multiple_delays_on_dependency():
    ...
    expected = ParsedCommand(None, None, [Dependency("A", False, [1.0, 0.5])], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_multiple_dependencies():
    ...
    expected = ParsedCommand(None, None, [
        Dependency("A", False, []),
        Dependency("B", True, [])
    ], [], ["echo", "hello"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_full_command_format():
    ...
    expected = ParsedCommand("worker", "blue", [
        Dependency("A", False, [1.0]),
        Dependency("B", True, [])
    ], ["silent"], ["python", "script.py"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_dependencies_with_actions():
    ...
    expected = ParsedCommand(None, None, [
        Dependency("DB", False, []),
        Dependency("API", True, [2.0])
    ], ["silent", "end"], ["echo", "done"])
    assert result == expected, f"Expected {expected}, got {result}"
...
def test_backward_compatibility():
    ...
    expected = ParsedCommand(None, None, [], [], ["echo", "test"])
    assert result == expected, f"Expected {expected}, got {result}"
    
    # Named commands
    result = parse("A=echo test")
    expected = ParsedCommand("A", None, [], [], ["echo", "test"])
    assert result == expected, f"Expected {expected}, got {result}"
    
    # Commands with color
    result = parse("A#red=echo test")
    expected = ParsedCommand("A", "red", [], [], ["echo", "test"])
    assert result == expected, f"Expected {expected}, got {result}"
    
    # Commands with actions
    result = parse("A#red|silent=echo test")
    expected = ParsedCommand("A", "red", [], ["silent"], ["echo", "test"])
    assert result == expected, f"Expected {expected}, got {result}"
