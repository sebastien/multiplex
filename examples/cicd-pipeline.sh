...
$PYTHON -m multiplex \
    ...
    "TESTS:BUILD=echo 'Running integration tests...'; sleep 1; echo 'Integration tests passed'" \
    ":TESTS|end=echo 'Deploying to production...'; sleep 1; echo 'Deployment successful!'"